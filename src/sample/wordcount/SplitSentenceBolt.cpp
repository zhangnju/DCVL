...
void SplitSentenceBolt::Prepare(std::shared_ptr<dcvl::collector::OutputCollector> outputCollector) {
...
void SplitSentenceBolt::Execute(const dcvl::base::Tuple& tuple) {
