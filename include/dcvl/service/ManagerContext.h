...
namespace dcvl {
    namespace service {
        ...
        public:
            ...
            const dcvl::base::NetAddress& GetNetAddress() const {
                return _netAddress;
            }

            void SetNetAddress(const dcvl::base::NetAddress& netAddress) {
            ...
            std::vector<dcvl::task::TaskInfo>& GetTaskInfos() {
                return _taskInfos;
            }

            const std::vector<dcvl::task::TaskInfo>& GetTaskInfos() const {
                return _taskInfos;
            }
            ...
            const dcvl::task::TaskInfo& GetTaskInfo(int32_t index) const {
                return _taskInfos[index];
            }

            const dcvl::task::TaskInfo& GetSpoutTaskInfo(int32_t index) const {
                return _taskInfos[index];
            }

            const dcvl::task::TaskInfo& GetBoltTaskInfo(int32_t index) const {
                return _taskInfos[_spoutCount + index];
            }

            dcvl::task::TaskInfo& GetTaskInfo(int32_t index) {
                return _taskInfos[index];
            }

            dcvl::task::TaskInfo& GetSpoutTaskInfo(int32_t index) {
                return _taskInfos[index];
            }

            dcvl::task::TaskInfo& GetBoltTaskInfo(int32_t index) {
                return _taskInfos[_spoutCount + index];
            }

            void SetTaskInfo(int32_t index, const dcvl::task::TaskInfo& info) {
                _taskInfos[index] = info;
            }

            int32_t SetSpoutTaskInfo(int32_t index, const dcvl::task::TaskInfo& info) {
                _taskInfos[index] = info;

                return index;
            }

            int32_t SetBoltTaskInfo(int32_t index, const dcvl::task::TaskInfo& info) {
        ...
        private:
            std::string _id;
            dcvl::base::NetAddress _netAddress;
